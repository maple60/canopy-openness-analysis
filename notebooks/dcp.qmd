---
title: "Digital Cover Photography（DCP）の解析（非専門家向け）"
...
- 晴天の直射日光下より、**薄曇りなどコントラストが安定する条件**で撮影する
- 比較したい写真は、**撮影角度・高さ・時刻をそろえる**
- 自動二値化の結果を必ず目視確認する（誤分類がないか）

この 3 点を守ると、再現性が高くなります。
